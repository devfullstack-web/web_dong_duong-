...
async function seedChineseLocalization() {
    ...
    try {
        ...
        // 5. UPDATE SYSTEM SETTINGS (site_info, brand_partners, hero_slides)
        console.log('5. Localizing System Settings...');
        
        // Brand Partners with localized labels
        const brandPartnersZH = [
            {
                id: 'dongtam',
                name: 'DONGTAM GROUP',
                shortName: '董心集团 (Dongtam)',
                category: 'tiles',
                sector: '陶瓷地砖、微晶石板与艺术装饰砖',
                desc: '越南国家级建材领导品牌，专注高抗折通体大理石地砖与艺术复古瓷砖。',
                badge: '核心战略总代',
                discount: '工程特惠 17% - 20%',
            ...
            },
            {
                id: 'viglacera',
                name: 'VIGLACERA',
                shortName: '维格拉塞拉 (Viglacera)',
                category: 'tiles',
                sector: '大规格岩板 (Big Slab) 与抗菌瓷砖',
                desc: '引领超大规格岩板制造科技，纳米抗菌釉面，广泛服务国家重点工程。',
                badge: '核心战略伙伴',
                discount: '工程特惠 17% - 20%',
            ...
            },
            {
                id: 'catalan',
                name: 'CATALAN',
                shortName: '卡塔兰 (Catalan)',
                category: 'tiles',
                sector: '全瓷欧标仿石岩板',
                desc: '全套引进欧洲萨克米原装生产线，意大利原创石纹设计，出口欧美品质。',
                badge: '特级授权经销商',
                discount: '工程特惠 17% - 20%',
            ...
            {
                id: 'thuanhai',
                name: 'THUAN HAI VACERAMIC',
                shortName: '顺海建材 (Vaceramic)',
                category: 'tiles',
                sector: '工程陶瓷地砖与外墙砖',
                desc: '越南南部规模最大的瓷砖仓储与配供基地之一，出厂价直供工区。',
                badge: '战略合作伙伴',
                discount: '工程特惠 17% - 20%',
            ...
            },
            {
                ...
                shortName: '河清实业 (DHT)',
                category: 'tiles',
                sector: '高强度地砖与建筑混凝土构件',
                desc: '大型多元化建材产业集团，生产品质卓越的重载高抗折工程地砖。',
                badge: '战略合作单位',
                discount: '工程特惠 17% - 20%',
            ...
            },
            {
                ...
                shortName: '格力电器 (Gree)',
                category: 'hvac',
                sector: '变频分体空调 / GMV 多联机 / 冷水机组',
                desc: '全球最大空调制造商之一，核心掌握掌握全直流变频科技，超级节能。',
                badge: '一级战略总代理',
                discount: '工程特惠 20% - 25%',
            ...
            },
            {
                id: 'midea',
                name: 'MIDEA HVAC',
                shortName: '美的暖通 (Midea)',
                category: 'hvac',
                sector: '商用空调 / 螺杆与离心式冷水机组',
                desc: '世界500强全方位暖通楼宇解决方案，从超薄风管机到特大型工业冷水机。',
                badge: '一级战略总代理',
                discount: '工程特惠 20% - 25%',
            ...
            },
            {
                id: 'vnsteel_hmc',
                name: 'VNSTEEL (HMC)',
                shortName: '越南钢铁 (VNSTEEL)',
                category: 'steel',
                sector: '建筑螺纹钢、型钢与结构钢',
                desc: '越南国家级大型钢铁龙头，保质保量直供越南南部各大施工项目仓库。',
                badge: '核心钢材供应商',
                discount: '原厂直发出厂价',
        ...
        // We can store brand partners array directly
        await client.query(
            `UPDATE system_settings 
             SET value = $1, updated_at = NOW() 
             WHERE key = 'site_brand_partners'`,
            [JSON.stringify(brandPartnersZH)]
        );
        console.log(' - Updated site_brand_partners in system_settings');
