...
__export(schema_exports, {
  ...
  chatSessionStatusEnum: () => chatSessionStatusEnum,
...
var categories = (0, import_pg_core.pgTable)("categories", {
  ...
  name_localized: (0, import_pg_core.jsonb)("name_localized").$type(),
  category_type_id: (0, import_pg_core.uuid)("category_type_id").references(() => categoryTypes.id, { onDelete: "restrict" }).notNull(),
  parent_id: (0, import_pg_core.uuid)("parent_id"),
  display_order: (0, import_pg_core.integer)("display_order").default(0).notNull(),
  is_visible: (0, import_pg_core.boolean)("is_visible").default(true).notNull()
});
...
var products = (0, import_pg_core.pgTable)("products", {
  ...
  description_localized: (0, import_pg_core.jsonb)("description_localized").$type(),
  ...
  tech_specs_localized: (0, import_pg_core.jsonb)("tech_specs_localized"),
  features: (0, import_pg_core.jsonb)("features"),
  // Array of highlighting features
  features_localized: (0, import_pg_core.jsonb)("features_localized").$type(),
  gallery: (0, import_pg_core.jsonb)("gallery"),
  // Array of image URLs
  tech_summary: (0, import_pg_core.text)("tech_summary"),
  tech_summary_localized: (0, import_pg_core.jsonb)("tech_summary_localized").$type(),
...
var chatSessionStatusEnum = (0, import_pg_core.pgEnum)("chat_session_status", ["active", "resolved", "spam"]);
var chatSessions = (0, import_pg_core.pgTable)("chat_sessions", {
  ...
  guest_email: (0, import_pg_core.varchar)("guest_email", { length: 255 }),
  guest_phone: (0, import_pg_core.varchar)("guest_phone", { length: 50 }),
  ...
  last_message_preview: (0, import_pg_core.text)("last_message_preview"),
  unread_count: (0, import_pg_core.integer)("unread_count").default(0).notNull(),
  ...
  telegram_notified_at: (0, import_pg_core.timestamp)("telegram_notified_at"),
  is_active: (0, import_pg_core.boolean)("is_active").default(true).notNull(),
  created_at: (0, import_pg_core.timestamp)("created_at").defaultNow().notNull(),
  updated_at: (0, import_pg_core.timestamp)("updated_at").defaultNow().notNull()
});
...
var CronService = class {
  ...
  async getCleanupStats() {
    ...
    return {
      ...
      retentionDays: AUDIT_LOG_RETENTION_DAYS,
      oldestLogDate: (oldestLog == null ? void 0 : oldestLog.created_at) || null
    };
  }
  /**
...
var nextHostname = "localhost";
var listenHostname = process.env.HOSTNAME || "0.0.0.0";
var app = (0, import_next.default)({ dev, hostname: nextHostname, port });
