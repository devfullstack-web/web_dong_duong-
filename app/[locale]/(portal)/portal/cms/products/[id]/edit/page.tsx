                    ...
                    <div className="bg-white rounded-none border border-slate-100 p-3.5 md:p-4 space-y-5">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-3 hidden">
                                ...
                                <Input
                                    id="sku"
                                    className="h-9 bg-slate-100 border-none text-sm font-bold rounded-none text-slate-400 cursor-not-allowed"
                                    value={formData.sku}
                                    readOnly
                                    disabled
                                />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-3">
                                ...
                                <Input
                                    id="price"
                                    type="number"
                                    className="h-9 bg-slate-50 border-none text-sm font-bold rounded-none focus:ring-1 focus:ring-brand-primary/20"
